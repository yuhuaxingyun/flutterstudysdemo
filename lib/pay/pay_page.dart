        ...
        child: Column(
          children: <Widget>[
            MaterialButton(onPressed: () async {
              String orderInfo = getOrderInfoForAlipay("测试", "支付宝付款", "0.01", "201212226");
              String signStr =
...
//              print(result);
              ...
              child: Text('支付宝支付',style: TextStyle(fontSize: 24,color: Colors.red,), ),
            ),
            SizedBox(height: 5,),
            MaterialButton(
              onPressed: (){},
//              Colors.purple
              child: Text('支付宝支付',style: TextStyle(fontSize: 24,color: Colors.grey,), ),
            )
          ],
        ),
      ),
  ...
  String getOrderInfoForAlipay(String subject,String body,String price,String orderNo) {
